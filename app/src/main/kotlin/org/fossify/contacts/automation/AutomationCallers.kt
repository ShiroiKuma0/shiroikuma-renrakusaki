...
object AutomationCallers {
     ...
     *
     * (The reference implementation parks the command in a `HOW_TO_DERIVE_PINS` constant. This fork's
     * detekt rejects an unused private property, and the command is already written out above, so the
     * documentation lives here alone rather than twice.)
     */
    /**
